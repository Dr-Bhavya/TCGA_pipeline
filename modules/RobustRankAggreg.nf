 ...
 * ============================================================================
 * MODULE: RRA
 * Description: Performs Robust Rank Aggregation (RRA) meta-analysis across all 
 *              cancers and generates prioritization volcano/rank plots.
 * ============================================================================
 */
process RRA {
    ...
    script:
        ...
        # =========================================================================
        # PHASE 3: ROBUST RANK AGGREGATION CORE ENGINE
        # =========================================================================
        run_list_rra <- function(compiled_ids_list, output_name, mode) {
            ...
            rra_res\$Category[sig_idx] <- "Significant_Low_Freq" 
